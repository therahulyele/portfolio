...
import WeotoTechnologies from "./Descriptions/WeotoTechnologies";
import WeotoTechnologiesIntern from "./Descriptions/WeotoTechnologiesIntern";
...
export default function WhereIHaveWorked() {
  ...
  const GetDescription = () => {
    switch (DescriptionJob) {
      case "WeotoTechnologies":
        return <WeotoTechnologies />;
      case "WeotoTechnologiesIntern":
        return <WeotoTechnologiesIntern />;
      // case "FeverTokens":
      //   return <FeverTokens />;
      // case "IdealFresh":
      //   return <IdealFresh />;
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("WeotoTechnologies");
  return (
...
const CompaniesBar = props => {
  ...
  const [companyNameBackgroundColorGreen, setCompanyNameBackgroundColorGreen] = React.useState<boolean[]>([    true,]);
    ...
    >
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        ...
        <CompanyButton
            ...
            CompanyName="Weoto Technologies"
            BarPosition={-12}
            BarAvobePosition={1}
            DescriptionJob="WeotoTechnologies"
          ...
          <CompanyButton
            ...
            DescriptionJob="WeotoTechnologiesIntern"
