...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        I&apos;m a dynamic <span className="text-AAsecondary">FullStack Developer</span>, with over <span className="text-AAsecondary">3 years of hands-on experience</span> in web development, I specializes in creating <span className="text-AAsecondary">seamless digital solutions</span>. My expertise in <span className="text-AAsecondary">React.js, Node.js,</span> and <span className="text-AAsecondary">Express.js</span> fuels my passion for crafting efficient backend systems and intuitive user interfaces. Let&apos;s turn your ideas into reality!
      </motion.h3>
      <motion.div
        initial={{ y: 10, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
